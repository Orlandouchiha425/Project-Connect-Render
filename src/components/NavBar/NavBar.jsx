                ...
                <Modal className='nav-bar-modal fade-in'
                    ...
                    <form onSubmit={handleSubmit}>
                        <label>Email Address <br/>
                            <input type='email' name='email' onChange={handleChange} placeholder='use This Email: test246@gmail.com'/><br/>
                        </label>
                        <br/>
                        <label>Password<br/>
                            <input type='password' name='password' onChange={handleChange} placeholder='use this password: 123456'/>
                        </label>
